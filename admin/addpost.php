...
<div class="grid_10">
    ...
    <div class="box round first grid">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($title == "" || $cat_id == "" || $tags == "" || $author == "" || $body == "" || $file_name == "") {
                ...
                $query = "INSERT INTO tbl_post(cat_id,title, body, image, author,tags ) 
                       VALUES('$cat_id','$title','$body','$uploaded_image','$author','$tags')";
